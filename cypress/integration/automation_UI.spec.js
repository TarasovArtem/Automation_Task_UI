...
describe('Automation Task - UI', () => {
    before(() => {
        navigation.navigate(); // Opens the website
        automation.cookieBanner(); // Closes cookie banner
    })

    beforeEach(() => {
        Cypress.Cookies.preserveOnce('SESSION', 'nhsuk-cookie-consent')// Preserves Cookies       
    })
